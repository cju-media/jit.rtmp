...
if (APPLE AND NOT "${PROJECT_NAME}" MATCHES "_test")
	...
	if(MAX_SDK_CODESIGN_EXTERNS)
		...
		add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD
			# Strip extended attributes (e.g. com.apple.FinderInfo / iCloud provenance attrs picked up
			# when the project lives under an iCloud-synced Documents folder) - codesign refuses to sign
			# a bundle carrying "resource fork, Finder information, or similar detritus".
